  ...
  return (
    <section id="about" className="min-h-screen sm:min-h-0 bg-gray-50">
      <div
        ...
        <h2 className="2xl:wrap-big md:wrap wrap-sp title text-shadow min-h-about md:min-h-video lg:text-left lg:text-6xl">
          About
        </h2>
      </div>
      <div className="lg:pl-60 -mt-8 lg:mt-3">
        <div className="2xl:wrap-big md:wrap wrap-sp text-gray-350 bg-gray-50">
