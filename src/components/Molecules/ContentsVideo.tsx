...
const ContentsVideo = () => (
  <section
    ...
    <h2 className="2xl:wrap-big title text-gray-350 lg:text-left lg:text-6xl absolute top-10 left-0 right-0 m-auto lg:top-20 lg:left-80 2xl:top-0 2xl:left-60">
      Video
    </h2>
